...
/**
 * Resolves token values by requesting the user to enter them via the Command Line Interface.
 */
class CliTokenResolver extends AbstractTokenResolver
{
    /** @var string[] */
    protected $registeredTokenValues = array();
    /** @var string */
    protected $defaultTokenValueRequestMessage = 'Please enter a value for "%s" (default: %s): ';
